...
In addition to censoring, survival data can include _truncation_.
Truncation is the process of fully excluding data whereas censoring is a mechanism to capture partial data.
...
1. First look at data to identify time and outcome
2. Do you need survival or EHA?
3. Identify type of censoring and truncation
4. Use that to identify metrics
5. Use that to identify models
6. Run experiments
