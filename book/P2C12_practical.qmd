...
Discrimination measures and scoring rules are usually extended to the competing risk setting by either evaluating cause-specific probabilities individually [@vanGeloven2022; @Lee2018a] and then potentially summing or averaging over cause-specific evaluations.
...
where $\dvec{\hat{h}_e}{m}$ are cause specific hazards for individual observations risk of event $e$.
