...
Many losses used in practice, on the other hand, are non-negative; for example the *absolute loss*, the absolute difference between a prediction and the true value, $L(y, \hat{y}) = \vert y - \hat{y} \vert$\index{absolute error}.
