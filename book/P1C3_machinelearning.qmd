...
Continuing this process for too long leads to overfitting\index{overfitting} in which the model starts to capture noise specific to the training data and generalizes poorly to new observations.
