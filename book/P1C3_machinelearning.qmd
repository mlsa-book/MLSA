...
In particular, the focus of this chapter is on machine learning concepts including tasks, learners, loss functions, resampling, and evaluation, which are essential for understanding how survival analysis problems can be formulated and evaluated using machine learning.
