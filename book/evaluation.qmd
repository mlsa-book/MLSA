...
All measures discussed in this chapter, with the exception of the Blanche AUC, have been implemented in  $\proba$ (@sec-tools). The listed measures above are utilised in the benchmark experiment in @sec-bench.
