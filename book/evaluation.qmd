...
As well as the concordance indices discussed here, another promiment alterntive was derived by  G\"onen and Heller (2005) [@GonenHeller2005]. However as this is only applicable to the Cox PH it is out of scope for this book, which is primarily concerned with generalisable measures for model comparison.
