...
| **id** ($i$) | **age** $(\xx_{;1})$ | **sex** $(\xx_{;2})$ | **complications** $(\xx_{;3})$ | **days** ($\tt$) | **status** ($\dd$) |
|---:|---:|:------|:-------------|----:|------:|
...
It occurs when the event of interest was not experienced during the observation period, which may happen because it was no longer observable (for example, due to withdrawl from the study) or because the event did not happen until study end.
