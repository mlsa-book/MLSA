...
Finally, in order to cleanly discuss 'machine learning survival analysis', we will introduce the *Survival Task* in Section @sec-surv-setmltask as an addition to the more common regression and classification tasks.
