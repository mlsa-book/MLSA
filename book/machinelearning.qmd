...
\section{Machine Learning} {#sec-surv-setml}
...
\subsection{Terminology and Methods} {#sec-surv-setml-meth}
...
\newpage
\subsection{Machine Learning in Classification and Regression} {#sec-surv-ml-car}
...
\subsubsection{Classification} {#sec-surv-ml-car-class}
...
\subsubsection{Regression} {#sec-surv-ml-regr}
...
\section{Survival Analysis Task} {#sec-surv-setmltask}
