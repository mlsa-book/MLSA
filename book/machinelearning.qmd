...
* Predict age from a subset of features - supervised regression task
* Predict sex from a subset of features - supervised classification task
...
$$
(\hat{\beta_0}, \hat{\beta_1}) := \argmin_{\beta_0,\beta_1} \Big\{\sum^n_{i=1} (y_i - \gamma\beta_0 - \beta_1 x_i)^2\Big\}
$$
