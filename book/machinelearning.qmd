...
*An Introduction to Statistical Learning* [@Hastie2013] provides a very good introduction to machine learning, with more detail in *The Elements of Statistical Learning* @Hastie2001.
There are several books covering machine learning implementations in various programming languages, for example *Applied Machine Learning Using mlr3 in R* [@Bischl2024] and *Tidy Modeling* [@Kuhn2023] for $\Rstats$ and *Hands-on Machine Learning with Scikit-Learn, Keras, and TensorFlow* [@Geron2019] for Python.
