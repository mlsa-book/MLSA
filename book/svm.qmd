...
& \textrm{subject to}
\begin{dcases}
& \textcolor{blue}{g(x_i) - g(x_{j(i)})} & \textcolor{blue}{\leq t_i - t_{j(i)} + \xi_i} \\
& \textcolor{red}{\Delta_i(g(x_i) - t_i)} & \textcolor{red}{\leq \xi^*_i} \\
& \textcolor{red}{t_i - g(x_i)} & \textcolor{red}{\leq \xi'_i} \\
& \textcolor{blue}{\xi_i}, \textcolor{red}{\xi_i', \xi_i^*} & \geq 0 \\
& \forall i = 1,...,n \\
\end{dcases}
\end{aligned}
...
$C$ is the penalty associated with the regression method and $\mu$ is the penalty associated with the ranking method setting $C = 0$ results in the regression SVM and $\mu = 0$ results in the ranking SSVM.
...
$$
\hatg(\xx^*) = \sum^n_{i=1} \textcolor{blue}{\alpha_i(K(\xx_i, \xx^*) - K(\XX_{j(i)}, \xx^*))} + \textcolor{red}{\alpha^*_i K(\xx_i, \xx^*) - \Delta_i\alpha_i'K(\xx_i, \xx^*)} + \beta_0
$$
