...
$$
MAE_C(\hattt, \tt, \dd) = \frac{1}{d} \sum^m_{i=1} \delta_i|t_i - \hatt_i|
$$
...
$$
MSE_C(\hattt, \tt, \dd) = \frac{1}{d}\sum^m_{i=1}\delta_i(t_i - \hatt_i)^2
$$
...
$$
RMSE_C(\hattt, \tt, \dd) = \sqrt{MSE_C(\hattt, \tt, \dd)}
$$
...
$$
MAE_C(\hattt, \tt, \dd, \lambda, \mu, \phi) = \frac{1}{d} \sum^m_{i=1} \delta_i|(t_i - \hatt_i) [\lambda\II(t_i>\hatt_i) + \mu\II(t_i<\hatt_i) + \phi\II(t_i=\hatt_i)]|
$$
