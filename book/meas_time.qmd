...
$$
MAE_C(\hatt, t, \delta) = \frac{1}{d} \sum^m_{i=1} \delta_i|t_i - \hatt_i|
$$
...
$$
MAE_C(\hatt, t, \delta, \lambda, \mu, \phi) = \frac{1}{d} \sum^m_{i=1} \delta_i|(t_i - \hatt_i) [\lambda\II(t_i>\hatt_i) + \mu\II(t_i<\hatt_i) + \phi\II(t_i=\hatt_i)]|
$$

where $\lambda, \mu, \phi$ are any Real number to be used to weight over-, under-, and exact-predictions.
