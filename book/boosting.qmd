...
\section{Gradient Boosting Machines} {#sec-surv-ml-models-boost}

\subsection{Gradient Boosting Machines for Regression} {#sec-surv-ml-models-boost-regr}
...
\subsection{Gradient Boosting Machines for Survival Analysis} {#sec-surv-ml-models-boost-surv}
