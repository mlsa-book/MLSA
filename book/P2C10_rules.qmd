...
1. Not experienced the event --- $\II(t_i > \tau)$;
2. Experienced the event --- $\II(t_i \leq \tau, \delta_i = 1)$; or
3. Been censored --- $\II(t_i \leq \tau, \delta_i = 0)$
...
$$
L_{RGS}(\hatS_i, t_i, \delta_i|\KMG) = \delta_i \int^{\tau^*}_0 \frac{(\II(t_i \leq \tau) - \hatF_i(\tau))^2}{\KMG(t_i)} \ d\tau
$$

<!-- TODO: DISCUSS PARA BELOW -->
