...
Analogously to the ISBS, the absolute survival loss consistently estimates the mean absolute error when censoring is fully independent [@Schmid2011], but there are also no proofs or claims of properness.
