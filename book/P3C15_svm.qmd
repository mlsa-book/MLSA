...
* Regression or hybrid model, experiments have demonstrated that the 'survival time' estimates from SSVMs can be unrealistically large [@Burk2026] as such it is safest to treat all predictions from SSVMs as relative risks and not attempt to interpret them as survival times.
