...
The most common symbols and notation used throughout this book are presented below; where different meanings are intended within the book, this will be made clear.
...
For any random variables, $A,B$, we write $A \indep B$, to denote that $A$ and $B$ are independent, i.e., that $P(A \cap B) = P(A)P(B)$.
