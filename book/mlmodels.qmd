...
\\\\
(@tab-surv-ml-returns) provides information about the models reviewed in this survey, including a model reference for use in the (@chap-bench) benchmark experiment, the predict types of the model, and in which \Rstats{} package it is implemented.
...
* 2. Model identifier used in this section and (@chap-bench).
