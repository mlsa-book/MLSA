...
\providecommand{\dvec}[2]{\bm{{#1}} = ({#1}_1 \ {#1}_2 \cdots {#1}_{#2})^\trans}
...
\providecommand{\bsdelta}{\bm{{\delta}}}
\providecommand{\bsbeta}{\bm{{\beta}}}
\providecommand{\bseta}{\bm{{\eta}}}
\providecommand{\bsxi}{\bm{{\xi}}}
\providecommand{\bsphi}{\bm{{\phi}}}
\providecommand{\bsvarphi}{\bm{{\varphi}}}
\providecommand{\bstheta}{\bm{{\theta}}}
\providecommand{\bslambda}{\bm{{\lambda}}}
