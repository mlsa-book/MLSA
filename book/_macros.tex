...
\providecommand{\dvec}[2]{\boldsymbol{\mathbf{#1}} = ({#1}_1 \ {#1}_2 \cdots {#1}_{#2})^\trans}
\providecommand{\tildey}{\tilde{y}}
...
\providecommand{\bszeta}{\boldsymbol{\zeta}}
...
\providecommand{\bsgamma}{\boldsymbol{\gamma}}
\providecommand{\bsnu}{\boldsymbol{\nu}}
...
\providecommand{\RStats}{\textsf{R}\xspace}
\providecommand{\Python}{\textsf{Python}\xspace}
\providecommand{\etal}{\textit{et al.}\xspace}
\providecommand{\tbk}{t_{(k)}}
\providecommand{\tbkq}{t_{q;(k)}}
