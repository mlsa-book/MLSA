...
![Left: Kaplan-Meier estimate of survival probabilities of infants depending on status of the mother ignoring left-truncation. Right: Kaplan-Meier estimate of survival probabilities adjusting for left-truncation.](Figures/survival/fig-p1c4-km-infants.png){#fig-p1c4-km-infants width=90% fig-align="center" fig-alt="Two plots both with two Kaplan-Meier curves. The left plot shows a red curve staying relatively close to S(t)=1 and a blue curve with plateauing quickly around S(t)=0.6. The right plot is very similar and the curves have the same shapes except both curves are lower indicating lower survival probabilities for each group."}
