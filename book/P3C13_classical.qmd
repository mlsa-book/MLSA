...
Machine learning models such as random forests (@sec-ranfor), gradient boosting (@sec-boost), and neural networks (@sec-nnet) are designed to learn such functions directly from data, without the need to pre-specify the range of possible effects.
