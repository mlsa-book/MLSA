...
Thirdly, an increase in a covariate results in a multiplicative increase over *time* compared to the PH model in which the hazard is increased.
...
As before, extension to other censoring types and truncation follows by specifying the correct likelihood form from @sec-surv-estimation-param.
