...
(@eq-partial) also assumes that there are no ties in the event time, that is, no two subjects have an event at the same time.
...
* @Collett2014 and @Kalbfleisch1980 both provide comprehensive reading for traditional statistical models. The former is slightly less technical and covers extensions to multiple settings.
