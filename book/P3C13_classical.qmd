...
In complex machine learning algorithms, the Kaplan-Meier estimator is often used to estimate the baseline survival, $S_0$, the hazard then follows from $h_0(\tau) = -S'(\tau)/S(\tau)$.
