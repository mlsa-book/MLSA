...
In a predictive setting, it can be easy to dismiss survival models that have been around for decades ('foundational models') and instead favor testing of more modern 'machine learning' tools\index{machine learning}. This would be a mistake.
