...
(@eq-partial) is thereforer eferred to as a *partial likelihood* [@Cox1975] function, as it does not make use of all the observed data.
...
<!--  -->
$$
\hat{\bsbeta} = \argmax_{\bsbeta}\ \mathcal{l}_{PL}(\bsbeta).
$${#eq-estimate-beta}
