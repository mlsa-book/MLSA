...
Therefore, selecting an alternative distribution, for example log-logistic or log-normal, can be particularly useful if the PH assumption does not hold up.
