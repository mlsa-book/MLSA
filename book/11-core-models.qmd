...
This third point is visualized in @fig-phaft in which the linear predictor is increased by $\log(2)$ for a PH model and decreased by $\log(2)$ for an AFT model.
