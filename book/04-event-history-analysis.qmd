...
![Estimation of the probability of dying in the ICU conditional on pneumonia status at admission. Dashed lines give the probabilities under assumption of right-censoring. Solid lines give the probabilities when taking into account discharge as competing risk.](Figures/survival/fig-p1c5-cens-vs-cr.png){#fig-p1c5-cens-vs-cr width=70% fig-align="center" fig-alt="Graph of four CIF curves. A solid blue curve roughly linearly increases from (0,0) to (120, 0.25); a solid red curve is flat for the majority of the plot around 0.09 on the y-axis; a dashed, blue curve roughly linearly increases to (120, 0.75) and a dashed, red curve roughly linearly increases to around (120, 0.6)."}
