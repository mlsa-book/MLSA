...
The first reduction transforms the survival problem to binary classification to estimate survival probabilities at a set of fixed times (@sec-icpw-reduction).
