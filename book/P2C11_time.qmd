---
abstract: This chapter discusses evaluation of distance measures for evaluating the distance between survival time predictions and the ground truth. The chapter explains why such evaluations are fundamentally problematic, and should be avoided, in the presence of censoring.
---
...
<!-- TODO (Raphael): maybe soften the stance a bit. @Qi2023 (the pseudo-observation approach) appears to propose a *correct* ranking measure based on distance — if its properties are good, the chapter could recommend it as a usable distance-based ranking tool rather than discouraging distance-based evaluation outright. -->
