...
This is in contrast to how IPC is used in the C-index (@sec-cindex) and various scoring rules (@sec-rules), where censored observations are at least partially included in the calculation.
