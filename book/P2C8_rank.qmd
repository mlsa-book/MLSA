...
The following are just some of weights that have been proposed for the concordance index:
...
In practice, given that competing risk models estimate cause-specific hazard functions, it is a variation of Antolini's time-dependent concordance measure that suits the competing risks setting best.
...
<!-- TODO:
1. https://pmc.ncbi.nlm.nih.gov/articles/PMC7806230/
2. https://onlinelibrary.wiley.com/doi/10.1002/sim.4178
3. https://journals.sagepub.com/doi/10.1177/0962280214531691
 -->
...
@Hartman2022 demonstrate that evaluating discrimination in the presence of these 'nonoverlapping intervals' creates bias if truncation is dependent on the predictors.
