...
@fig-mulit-state depicts a more general multi-state setting with back-transitions. One can think of transitions between a healthy state (0) to different non-terminal disease progressions (1, 2) with possibilty of improvement and recovery, with possible transition to a terminal state (3).
