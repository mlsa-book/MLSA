...
Moreover, even when prediction is the primary goal, it has been repeatedly shown that machine learning models can be out-performed by the Cox PH model in real-world settings [e.g., @Burk2026; @Zhang2021; @Beaulac2020].
