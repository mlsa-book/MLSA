...
Recall from @sec-ml-basics that a general prediction problem is one in which:

1. a dataset, $\calD$, is split for training, $\dtrain$, and testing, $\dtest$;
2. a model is fit on $\dtrain$; and
3. the model predicts a representation of the unknown ground truth, $Y$, given $\dtest$.
...
Survival analysis introduces complexity in defining the 'representations of $Y$'; this is the focus of this chapter.
