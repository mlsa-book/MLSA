...
In applied predictive modelling, _direct_ survival time predictions are uncommon as they can be challenging to estimate and evaluate reliably under censoring, particularly when prediction requires extrapolation beyond the observed follow-up period.
...
In machine learning, this idea is generalized by conditioning on the full covariate vector, yielding one predicted survival distribution per individual.
...
Using the ensemble mortality approach yields relative risk scores of 
