...
$$ {#eq-km}
As this estimate is so important in survival models, this book will always use the symbol $\KMS$ to refer to the Kaplan-Meier estimate of the average survival function fit on training data $(T_i, \Delta_i)$. Another valuable function is the Kaplan-Meier estimate of the average survival function of the \emph{censoring} distribution, which is the same as above but estimated on $(T_i, 1 - \Delta_i)$, this will be denoted by $\KMG$.
