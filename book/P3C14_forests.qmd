...
Once the Nelson-Aalen estimate for the cumulative hazard function is estimated for individual trees, the question is then how how to combine them to create a single random forests prediction.
...
* RSFs have been proven to perform well in benchmark experiments on high-dimensional data, see @Herrmann2020 and @Spooner2020 for examples.
