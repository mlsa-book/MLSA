...
@fig-mcycle-det-vs-prob visualizes the contrast between deterministic and probabilistic regression on the `mcycle` data.\index{regression!probabilistic}
...
@fig-weibull-aft-nn illustrates how increasing the flexibility of the parameterization allows the model to represent increasingly complex survival patterns under the same model class and training procedure.
