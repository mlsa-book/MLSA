...
In this section we consider the different prediction types that might be of interest in the survival analysis context and introduce the notion of a survival task more formally.
