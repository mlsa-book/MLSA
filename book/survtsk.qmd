...
A prognostic index is a special case of a ranking prediction, assuming that there is a one-to-one mapping between the prediction and expected survival times.
