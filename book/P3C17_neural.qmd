...
@fig-p3c17-weibull-aft-nn illustrates how increasing the flexibility of the parametrization allows the model to represent increasingly complex survival patterns under the same model class and training procedure.
