...
The NPMLE is a step function on this grid; only intervals contained in some observation interval $(L_i, R_i]$ can carry positive mass [@Peto1973; @Turnbull1976], and Algorithm 1 assigns zero mass to the rest automatically.
