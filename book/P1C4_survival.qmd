...
For example, given survival data, $(t_1=5, \delta_1=0), (t_2=1, \delta_2=1), (t_3=10,\delta_3=1), (t_4=5,\delta_4=0)$ the ordered unique event times are $(t_{(1)},  t_{(2)}) = (1,10)$.

<!-- FIXME: Not entirely sure about the definition below, as it already uses the () notation in  the set definition  -->
Formally, we define the **unique, ordered event times** as
<!--  -->
$$
