...
Although, note that the reductions introduced in part IV, particularly partition-based reductions @sec-partition-based-reductions, lend themselves to modeling time-varying covariates [@Laird1981; @dagostinoRelationPooledLogistic1990a].
