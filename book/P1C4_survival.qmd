...
The thechniques discussed in section @sec-surv-estimation can also be used to estimate the distribution of censoring times $(t_i, 1-\delta_i)$. 
...
<!--  -->
$$
G_{KM}(t) = \prod_{\ell=1}^g \left(1-\frac{d^C_{t_{(\ell)}}}{n_{t_{(\ell)}}}\right), 
$$ {#eq-km-censoring}
<!--  -->
