...
Full discussion of time-varying covariates is outside the current scope and requires extensions to the standard survival analysis framework, often involving more complex data structures and modeling assumptions (although the reductions introduced in part IV of the book, particularly partition-based reductions @sec-partition-based-reductions, lend themselves to modeling time-varying covariates [@Laird1981; @dagostinoRelationPooledLogistic1990a]).
