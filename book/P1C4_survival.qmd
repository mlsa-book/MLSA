...
## Dependent vs. Informative Censoring {#sec-censoring-types}
...
### Non-parametric estimation {#sec-nonparametric}
...
Similar to the Kaplan-Meier estimator, $H_{NA}$ can deal with left-truncated data based on the general risk-set definition @eq-riskset-lt.
