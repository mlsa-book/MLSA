...
It then follows that the probability to survive beyond time point $\tau$ is given by
...
Based on @eq-nelson-aalen Breslow (@Breslow1972) suggested a survival probability estimate using the relationship in @eq-surv-haz as
